...
local load_light_theme = function()
  ...
  hi(0, "NormalFloat", { fg = colors.gray_1, bg = colors.gray_13 })
  hi(0, "FloatBorder", { fg = colors.gray_12, bg = colors.gray_13 })
  hi(0, "ColorColumn", { bg = colors.gray_12 })
  hi(0, "Conceal", { fg = colors.gray_5 })
  hi(0, "Cursor", { bg = colors.gray_1 })
  hi(0, "CursorIM", { bg = colors.gray_1 })
  hi(0, "CursorColumn", { bg = colors.gray_14 })
  hi(0, "CursorLine", { bg = colors.blue_13 })
  hi(0, "CursorLineNr", { bg = colors.gray_13 })
  hi(0, "vCursor", { link = "Cursor" })
  hi(0, "iCursor", { link = "Cursor" })
  hi(0, "lCursor", { link = "Cursor" })
  ...
  hi(0, "Folded", { bg = colors.blue_11 })
  -- hi(0, "FoldColumn", { fg = colors.gray_11, bg = colors.gray })
  hi(0, "MatchParen", { fg = colors.teal_5 })
  hi(0, "ModeMsg", { fg = colors.gray_1, bg = colors.blue_10 })
  hi(0, "MoreMsg", { fg = colors.gray_1, bg = colors.blue_10 })
  hi(0, "NonText", { fg = colors.gray_7 })
  hi(0, "Pmenu", { fg = colors.gray_1, bg = colors.gray_14 })
  hi(0, "PmenuSel", { bg = colors.blue_11 })
  hi(0, "PmenuSbar", { bg = colors.gray_14 })
  hi(0, "PmenuThumb", { fg = colors.gray_10 })
  -- hi(0, "Question", { fg = colors.cyan, bold = true })
  hi(0, "QuickFixLine", { bg = colors.blue_11 })
  hi(0, "qfLineNr", { fg = colors.blue_11 })
  hi(0, "Search", { fg = colors.gray_1, bg = colors.orange_6 })
  hi(0, "IncSearch", { bg = colors.blue_9 })
  hi(0, "SpecialKey", { fg = colors.orange_5 })
  hi(0, "SpellBad", { fg = colors.red_3, undercurl = true })
  -- hi(0, "SpellCap", { fg = colors.blue, bg = colors.none, italic = true, undercurl = true })
  -- hi(0, "SpellLocal", { fg = colors.cyan, bg = colors.none, italic = true, undercurl = true })
  -- hi(0, "SpellRare", { fg = colors.cyan, bg = colors.none, italic = true, undercurl = true })
  ...
  hi(0, "Title", { fg = colors.gray_7 })
  hi(0, "Visual", { bg = colors.blue_11 })
  hi(0, "VisualNOS", { bg = colors.gray_11 })
  hi(0, "WarningMsg", { fg = colors.yellow, bold = true })
  hi(0, "WildMenu", { fg = colors.gray_12, bg = colors.gray_2, bold = true })
  hi(0, "ToolbarLine", { fg = colors.gray_1, bg = colors.gray_13 })
  hi(0, "ToolbarButton", { fg = colors.gray_14, bg = colors.blue_4 })
  hi(0, "NormalMode", { fg = colors.blue_4 })
  hi(0, "InsertMode", { fg = colors.green_4 })
  hi(0, "VisualMode", { fg = colors.yellow_2 })
  hi(0, "CommandMode", { fg = colors.purple_4 })
  hi(0, "VertSplit", { fg = colors.gray_12 })
  hi(0, "Warnings", { fg = colors.warning })

  -- Syntax highlighting
  hi(0, "Type", { fg = colors.gray_1 })
  hi(0, "Typedef", { fg = colors.keyword })
  hi(0, "StorageClass", { fg = colors.keyword })
  hi(0, "Structure", { fg = colors.keyword })
  hi(0, "Constant", { fg = colors.constant })
  ...
  hi(0, "shQuote", { link = "StrintDelimiter" })
  hi(0, "htmlTag", { fg = colors.html_tag })
  hi(0, "yamlDocumentStart", { fg = colors.gray_1 })
  hi(0, "yamlBlockMappingKey", { fg = colors.keyword })
  hi(0, "yamlKeyValueDelimiter", { fg = colors.gray_1 })
  hi(0, "yamlComment", { link = "SpecialComment" })
  hi(0, "yamlAnchor", { link = "Label" })
  hi(0, "yamlBool", { fg = colors.gray_1 })
  hi(0, "yamlAlias", { link = "Label" })
  ...
  -- JavaScript
  hi(0, "@string.regex.javascript", { fg = colors.teal_7 })
  hi(0, "@comment.documentation.javascript", { link = "SpecialComment" })
  hi(0, "@keyword.jsdoc", { fg = colors.green_6 })
  hi(0, "@include.javascript", { fg = colors.gray_5 })
  hi(0, "@lsp.type.class.javascript", { fg = colors.gray_12 })
  hi(0, "@lsp.type.property.javascript", { fg = colors.constant })
